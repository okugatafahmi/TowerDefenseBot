...
public class Bot {
    ...
    public String run() {
        ...
        // membangun tesla bila sudah punya banyak energy
        if (myself.energy-100>=gameDetails.buildingsStats.get(BuildingType.TESLA).price){
        ...
        for (int i=0; i<gameHeight; ++i) {
            ...
            List<Building> friendBuildingDefense = getPlayerThingList(buildings, b->b.isEqual(y, BuildingType.DEFENSE, PlayerType.A));
